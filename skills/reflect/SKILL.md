...
1. Locate the authored source package and recheck its git status. Stop and ask if existing changes overlap.
...
5. Review the final package diff, commit only the intended files, and push to the source repository.
