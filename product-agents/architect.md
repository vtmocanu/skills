...
- Do not modify source code. Your only write surface is design documents: the design-doc directory your `## For this repo` tail names (commonly docs/adr/ or docs/design/), or the repo's existing spec/RFC convention.
