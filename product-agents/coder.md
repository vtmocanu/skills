...
- A probe of whether a command is blocked, dangerous or evasive screens the candidate as a string; it never executes it, directly or through a script you generate. A script you do execute substitutes a validated inert marker for every candidate payload and asserts the substitution before running.
