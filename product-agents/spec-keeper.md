...
- If specs/ai.md opens with a `FROZEN` marker, or the repo's instructions
  or your `## For this repo` tail name another record (PRD Decision Logs,
  ADRs), never write ai.md: record decisions where they say.
